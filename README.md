# ?? SuperPOS Ч Next-Gen Supermarket System
...
- ??? **SQLite** (better-sqlite3 / sql.js) Ц zero configuration
...
# Terminal 1 Ц backend
cd backend && npm install && npm run start:dev

# Terminal 2 Ц pos client
cd pos-client && npm install && npm run dev

# Terminal 3 Ц admin panel
